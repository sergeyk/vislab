function results = maxrew_eval(eval_params)
% [rewards, accuracies, height_portion, height_acc] = maxrew_eval(eval_params)
% Evaluates a hierarchical classifier learned by MAX-REW.
% Arguments:
...
for i = 1:numel(thresholds)
  ...
  preds = maxrew_predict(leaf_probs, tree_rewards, tree, thresholds(i));
