function thresholds = maxexp_bisection(bs_params)
% thresholds = maxexp_bisection(bs_params)
% Learns the thresholds for MAX-EXP via bisection.
% Arguments:
...
for i = 1:numel(accuracy_guarantees)
  ...
  for j = 1:num_bs_iters
    ...
    preds = maxexp_predict(leaf_probs, rewards, tree, current_threshold);
